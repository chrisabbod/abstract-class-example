...
/**
 * The Cat class is a subclass of the Animal abstract class. This means that it inherits all the
...
public class Cat extends Animal {
    public void makeNoise(Context context) {
        Toast.makeText(context.getApplicationContext(), "MEOW", Toast.LENGTH_SHORT).show();
    }
}
